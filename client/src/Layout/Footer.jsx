...
import logo from "../assets/images/7art.png"; // ✅ ADD THIS
    ...
    <footer className="footer">
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <p><i className="fas fa-envelope"></i> thc7arnarra@onegmail.com</p>
          ...
          <div className="footer-social">
            ...
            <a href="https://wa.me/919607540748" target="_blank" rel="noreferrer">
        ...
        {/* IMAGE */}
        <div className="footer-col footer-image-col">
